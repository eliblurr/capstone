...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['email','first_name','last_name','phone','employee_id','other_names','role','id','password', 'doctor', 'pharmacist', 'nurse', 'lab_technician', 'receptionist']
    ...
    def update(self, instance, validated_data):
        ...
        if instance.role==User.Types.PHARMACIST and pharmacist:
            [setattr(instance.pharmacist, k, v) for k, v in pharmacist.items()]
