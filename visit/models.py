...
class Visit(BaseModel):
    ...
    records = models.ForeignKey(Record, on_delete=models.DO_NOTHING, related_name='visits', null=True, blank=True)
    end_time = models.TimeField(auto_now=False, auto_now_add=False, null=True, blank=True)
    bill = models.ForeignKey("Bill", on_delete=models.CASCADE, related_name='visit', null=True, blank=True)
