...
class AppointmentSerializer(serializers.ModelSerializer):
    ...
    # patient = serializers.PrimaryKeyRelatedField(many=False, queryset=User.objects.filter(role=User.Types.PATIENT).all(), required=True)
    ...
    def to_representation(self, instance):
        ...
        # self.fields['patient'] = UserSerializer(many=False)
